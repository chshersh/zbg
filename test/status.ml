...
let%test_unit "unlines_one_string" =
  [%test_eq: string] (Status.unlines ["line 1"]) "line 1"

let%test_unit "unlines_two_strings" =
  [%test_eq: string] (Status.unlines ["line 1"; "line 2"]) "line 1\nline 2"

let%test_unit "unwords_two_words" =
  [%test_eq: string] (Status.unwords ["word1"; "word2"]) "word1 word2"

let%test_unit "wording_two_words" =
  [%test_eq: string list] (Status.words "word1 word2") ["word1"; "word2"]

let%test_unit "justify_left" =
  [%test_eq: string] (Status.justify_left 7 "0123") "0123   "

let%test_unit "justify_right" =
  [%test_eq: string] (Status.justify_right 7 "0123") "   0123"

(* patch_type *)

let%test_unit "parse_patch_type" =
  [%test_eq: Status.patch_type option] (Status.parse_patch_type "M") (Some Status.Modified)
...
let%test_unit "parse_diff_details_binary" =
  ...
  (Some { file = ".pancake.un~"; change_count = "Bin"; signs = "0 -> 412 bytes" })